        ...
        <section>
            <%
                ...
                if (orderid != null) {
                    ...
                    if (OrderDAO.updateOrdertStatusv2(email, orderID)) {
            %>
            <script >
            ...
            <table class="order">
                ...
                <tr>
                    ...
                    <td><%=  status[ord.getStatus()]%>
                        <br/>
                        <% if (ord.getStatus() == 1)%> <a href="canceledOrders.jsp?orderid=<%=ord.getOrderID()%>">Cancel Order</a>
