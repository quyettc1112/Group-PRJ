 ...
 * @author Admin
 */
public class changeProfileSevlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
                ...
                if (AccountDAO.updateAccountName_Phone(email, fullname, phone) == true && fullname != null && phone != null && email != null){
