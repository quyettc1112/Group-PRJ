...
public class sendOTP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.print("<link  rel='stylesheet' href='CSSS/mycss.css' type='text/css' />");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet sendOTP at " + request.getContextPath() + "</h1>");
            String email = (String ) request.getAttribute("email_newAccount");
            out.println("<p>Please, check your email:" + email  + ", a conform code is sent to you </p>");
            out.println("<a href ='index.jsp'>Click to Back Index </a>");
