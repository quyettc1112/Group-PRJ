<%-- 
    Document   : CSSHeader
    Created on : Feb 25, 2023, 10:04:10 PM
    Author     : Admin
--%>
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="CSS2/headers-css-master/styles/reset.min.css" />
        <link rel="stylesheet" href="CSS2/headers-css-master/styles/style.css" />
        ...
        <header class="site-header">
            <div class="site-header__top">
                <div class="wrapper site-header__wrapper">
                    ...
                    <div class="site-header__middle imgfix">
                        <a href="index.jsp" class="brand"><img src="images/logo.jpg"></a>
                    ...
                    <div class="site-header__end top">
                        ...
                        <c:if test="${not empty sessionScope.name}">
                            <a href="mainController?action=logout" class="button">Logout</a> 
                        </c:if>    
                    </div>
                </div>
            </div>
            <div class="site-header__bottom">
                <div class="wrapper site-header__wrapper">
                    <div class="site-header__start">
                        <nav class="nav">
                            ...
                            <ul class="nav__wrapper">
                                ...
                                <li class="nav__item"><a href="registration.jsp">Register</a></li>
                                <li class="nav__item"><a href="#">Services</a></li>
                                <li class="nav__item"><a href="#">Hire us</a></li>
                                <li class="nav__item"><a href="#">Contact</a></li>
                                <li class="nav__item"><a href="mainController?action=viewcart">View Cart</a></li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="site-header__end bottom">
                        ...
                        <a href="OrderDetail.jsp" class="cart">
                            <svg
                                version="1.1"
                                viewBox="0 0 100 100"
